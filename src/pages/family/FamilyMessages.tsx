...
const FamilyMessages: React.FC = () => {
  ...
  const conversations = [
    {
      ...
      avatar: 'JD',
      unread: 2,
      lastMessage: 'Your father had a good day today',
      lastTime: '4:30 PM'
    },
    {
      id: 2,
      ...
      avatar: 'AO',
      unread: 0,
      lastMessage: 'Updated care plan is available',
      lastTime: 'Yesterday'
    },
    {
      id: 3,
      ...
      avatar: 'RJ',
      unread: 0,
      lastMessage: 'We need to discuss medication changes',
      lastTime: 'May 20'
    },
  ];
  ...
  const messages = [
    {
      id: 1,
      sender: 'Jane Doe',
      content: 'Hello, I wanted to let you know that your father had a good day today. He completed his exercises and ate well.',
      time: '4:30 PM',
      isOutgoing: false
    },
    {
      id: 2,
      sender: 'You',
      content: 'That\'s great to hear! How was his mood today?',
      time: '4:35 PM',
      isOutgoing: true
    }
  ];
  ...
  return (
    <Layout title="Messages" role="family">

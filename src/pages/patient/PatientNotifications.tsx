...
import { Bell, CheckCircle, Calendar, User, AlertCircle, Clock } from 'lucide-react';
...
const PatientNotifications: React.FC = () => {
  ...
  const notifications = [
    {
      ...
      message: 'Jane Doe will be visiting you tomorrow at 10:00 AM',
      time: '2 hours ago',
      isRead: false,
    ...
    },
    {
      ...
      message: 'Take your blood pressure medication at 8:00 PM',
      time: 'Today',
      isRead: false,
      linkTo: '/patient/care-plan'
    },
    {
      id: 3,
      type: 'request',
      ...
      time: 'Yesterday',
      isRead: true,
      linkTo: '/patient/requests'
    },
    {
      id: 4,
      type: 'care-plan',
      title: 'Care Plan Updated',
      message: 'Your care plan has been updated by Dr. Johnson',
      time: 'May 20, 2025',
      isRead: true,
      linkTo: '/patient/care-plan'
    }
  ...
  return (
    <Layout title="Notifications" role="patient">

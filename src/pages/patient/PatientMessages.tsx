...
const PatientMessages: React.FC = () => {
  ...
  const conversations = [
    {
      ...
      avatar: 'SJ',
      unread: 1,
      lastMessage: 'Your test results are looking good',
      lastTime: '2:30 PM'
    },
    {
      id: 2,
      ...
      avatar: 'JD',
      unread: 0,
      lastMessage: 'I will be there at 3pm tomorrow',
      lastTime: 'Yesterday'
    },
    {
      id: 3,
      ...
      avatar: 'AO',
      unread: 0,
      lastMessage: 'Your insurance was updated',
      lastTime: 'May 20'
    },
  ];
  ...
  const messages = [
    {
      ...
      content: 'Hello, I wanted to let you know that your latest test results have come back and they look good. Your blood pressure has improved.',
      time: '2:30 PM',
      isOutgoing: false
    },
    {
      id: 2,
      sender: 'You',
      content: 'That\'s great news! Thank you for letting me know. Is there anything specific I should continue doing?',
      time: '2:33 PM',
      isOutgoing: true
    }
  ];
  ...
  return (
    <Layout title="Messages" role="patient">
